...
import com.ihrm.common.exception.BusinessException;
import com.ihrm.common.utils.ListUtil;
...
public class GlobalExceptionHandler {
    ...
    public Result illegalArgumentException(IllegalArgumentException e) {
        ...
        return Result.failed(ResultEnum.SYSTEM_SERVER_20204001);
    }
    ...
    public Result methodArgumentNotValidHandler(HttpServletRequest request, MethodArgumentNotValidException exception) {
        ...
        if (ListUtil.isNotEmpty(errorList)) {
            return Result.failedWith( ResultEnum.PARAM_ERROR.getCode(), errorList.get(0).getDefaultMessage(),null);
        }

        return Result.failedWith( ResultEnum.PARAM_ERROR.getCode(), "必填参数校验异常",null);
    }
    ...
    public Result methodArgumentNotValidHandler(UnexpectedTypeException exception) {
        return Result.failedWith( 500, exception.getMessage() ,null);
    }
    ...
    public Result businessException(BusinessException e) {
        ...
        return Result.failedWith( -1, e.getMessage(),null);
    }
    ...
    public Result parameterTypeException(HttpMessageConversionException exception) {
        ...
        return Result.failed(ResultEnum.TYPE_CONVERT_ERROR);
    ...
    public Result parameterTypeException(MissingServletRequestParameterException exception) {
        ...
        return Result.failedWith( ResultEnum.REQUEST_PARAMETER_EXCEPTION.getCode(), ResultEnum.REQUEST_PARAMETER_EXCEPTION.getMsg() + "==>" + exception.getMessage(),null);
    }
    ...
    public Result parameterTypeException(HttpRequestMethodNotSupportedException exception) {
        ...
        return Result.failedWith( ResultEnum.HTTP_REQUEST_METHOD_EXCEPTION.getCode(), ResultEnum.HTTP_REQUEST_METHOD_EXCEPTION.getMsg() + "==>" + exception.getMessage(),null);
    }
    ...
    public Result parameterTypeException(SQLSyntaxErrorException e) {
        ...
        return Result.failedWith(ResultEnum.SQL_SYNTAX_EXCEPTION.getCode(), ResultEnum.SQL_SYNTAX_EXCEPTION.getMsg() + "==>" + e.getMessage(),null);
    }
    ...
    public Result exception(Exception e) {
        ...
        return Result.failedWith( ResultEnum.GLOBAL_EXCEPTION.getCode(), ResultEnum.GLOBAL_EXCEPTION.getMsg(),null);
    }
}
